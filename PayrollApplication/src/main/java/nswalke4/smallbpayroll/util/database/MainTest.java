...
public class MainTest {
	...
	public static void main(String[] args) {
		...
		Account account = DatabaseQueries.getSpecificAccount("ada144e7-5084-49e4-a7e5-701f762ecacf");
	...
	/**
	 * Print's the Pay Period ID, Start Date, and End Date of all of the pay periods
	 * in the given list.
	 * 
	...
	/**
	 * Print's the EmployeeId, PayPeriodID, number of regular hours, overtime hours,
	 * bonus pay, and other pay for all of the timecards in the given list.
	 * 
	...
	private static void printTimecards(List<Timecard> timecards) {
		...
		for (Timecard t : timecards) {
			...
			System.out.println("     RegHrs: " + t.getRegularHours() + "\tOvertimeHrs: "
					+ t.getOvertimeHours());
			System.out.println("     BonusPay: " + t.getBonusPay() + "\tOtherPay: "
					+ t.getOtherPay());
		}
	}
